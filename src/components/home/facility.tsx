...
export async function Facility() {
  ...
  return (
    <section className="relative isolate min-h-[80svh] overflow-hidden">
      ...
      />
      <div className="absolute inset-0 -z-10 bg-gradient-to-r from-ink-1 via-ink-1/65 to-ink-1/15" />
      <div className="absolute inset-0 -z-10 bg-gradient-to-t from-ink-1 via-transparent to-transparent" />
      ...
      <div className="mx-auto flex min-h-[80svh] max-w-[1440px] flex-col justify-end px-6 py-24 lg:px-10 lg:py-32">
        <div className="max-w-2xl">
          ...
          <p className="mt-6 max-w-xl text-pretty text-lg leading-relaxed text-mist-2">
            {t('desc')}
          </p>
        </div>
        ...
        <div className="mt-16 grid grid-cols-2 gap-px bg-ink-4/70 backdrop-blur-sm sm:grid-cols-4">
          {[
            ...
            <div key={l} className="bg-ink-3/90 px-6 py-5 backdrop-blur-sm">
